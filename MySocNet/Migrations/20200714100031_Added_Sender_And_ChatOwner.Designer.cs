...
namespace MySocNet.Migrations
{
    ...
    [Migration("20200714100031_Added_Sender_And_ChatOwner")]
    partial class Added_Sender_And_ChatOwner
    {
            ...
            modelBuilder.Entity("MySocNet.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Larry",
                            Password = "$MYHASH$V1$100$qfMZ+RRPc74NSn3e6ZEysYHBWtpvjCZBaGrfLq1O+a6Md4Ru",
                            SurName = "Richi",
                            UserName = "ggg",
                            UserRole = "Admin"
                        });
