...
namespace MySocNet.Migrations
{
    ...
    [Migration("20200715102041_Added_Read_UnRead_TimeOfSending")]
    partial class Added_Read_UnRead_TimeOfSending
    {
            ...
            modelBuilder.Entity("MySocNet.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Larry",
                            Password = "$MYHASH$V1$100$SYFHTnzGQ97KMKTZIhUd9YpepC+e1CB2UPi3wj1sR+MDikJh",
                            SurName = "Richi",
                            UserName = "ggg",
                            UserRole = "Admin"
                        });
