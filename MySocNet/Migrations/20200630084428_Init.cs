    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "ActiveKeyId", "AuthenticationId", "Email", "FirstName", "Password", "SurName", "UserName", "UserRole" },
                values: new object[] { 1, null, null, "example@mail.hock", "Larry", "$MYHASH$V1$100$C/1ULVxocoopzUFe1GmPkzCoQLtEOyyNwfRPH5YOIfDXtDmd", "Richi", "ggg", "Admin" });
